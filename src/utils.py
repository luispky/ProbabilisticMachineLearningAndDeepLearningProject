...
class GaussianDataset:
    ...
    def __init__(self):
        self.dataset = None
        self.dataloader = None  # todo: I added this here, remember to declare everything in the __init__
    ...
    def generate_samples(self, mean, cov, num_samples):
        ...
        todo method may be static, maybe should move outside the class
        """
    ...
    def get_dataloader(self, means, covariances, num_samples_per_distribution, with_labels=False, labels=None,
